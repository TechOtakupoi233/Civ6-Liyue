...
VALUES	('en_US',	'LOC_BUILDING_STATUE_OF_THE_SEVEN_NAME',			'Statue of the Seven'),
		('en_US',	'LOC_BUILDING_STATUE_OF_THE_SEVEN_DESCRIPTION',		'Genshin Impact unique building that replaces the Monument. Provides an additional +2 [ICON_Faith] Faith. Provides +1 Loyalty per turn in this city. If the city already has maximum Loyalty, also provides an additional +1 [ICON_Culture] Culture.[NEWLINE][NEWLINE]Units instantly heals when moved to a Statue of the Seven. Each Statue of the Seven increases total healing power of your Statues by 25 per turn (up to 150) and the power is shared by all of them.'),
...
--------------------------------------------------------------
		...
		('zh_Hans_CN',	'LOC_BUILDING_STATUE_OF_THE_SEVEN_DESCRIPTION',		'替代纪念碑的原神特色建筑。额外提供 +2 [ICON_Faith] 信仰值。使此城市每回合 +1 忠诚度。如城市已拥有最高忠诚度，则额外 +1 [ICON_Culture] 文化值。[NEWLINE][NEWLINE]移动至七天神像的单位立即回复生命值。每座神像提升25点每回合的总回复力（最高150点），回复力由您境内所有的神像共享。'),
